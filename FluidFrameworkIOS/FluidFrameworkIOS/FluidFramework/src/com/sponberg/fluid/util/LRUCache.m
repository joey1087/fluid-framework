...
- (BOOL)removeEldestEntryWithJavaUtilMap_Entry:(id<JavaUtilMap_Entry>)eldest {
  ...
  if (shouldRemove) {
    for (id<FFTLRUCache_RemovedListener> __strong l in nil_chk(removedListeners_)) {
      [((id<FFTLRUCache_RemovedListener>) nil_chk(l)) entryWasRemovedWithId:[((id<JavaUtilMap_Entry>) nil_chk(eldest)) getKey] withId:[eldest getValue]];
    }
  }
